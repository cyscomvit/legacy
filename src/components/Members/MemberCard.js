...
export const MemberCard = (props) => {
  ...
  return (
    <div className='m-2 p-3 h-full  bg-gray-400 rounded-md bg-clip-padding backdrop-filter backdrop-blur-sm bg-opacity-10 border border-sky-600 '>
         <div className="card w-screen h-48  middle md:h-48 md:w-48 ">
      <div className="front flex flex-row justify-center items-center">
        <img onLoad={increment}  className={` md:max-w-[30rem] object-fit`} src={props.pic} alt=""/>
      </div>
      <div class="back">
